package com.example.week8camera.utils;
...
import com.example.week8camera.Fragments.LocalFragment;
...
public class LocalDataBaseAdapter extends RecyclerView.Adapter<LocalDataBaseAdapter.MyViewHolder> {
    ...
    public void deletedata(final int position, final ArrayList<LocalResponse> singleRowArrayList){
        new AlertDialog.Builder(context)
                ...
                .setMessage("Are you convinced you want to delete this picture?")
                ...
                .setNegativeButton("No, Retain", null)
                .show();
    }
